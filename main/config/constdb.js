...
module.exports = {
  ...
  CLISTDB : [
    db.createPostGress('mm', 'bitssu', '8175Pass', tabelAutonumber, tabelUser, 'Secret-Key-is=8175Pass', 'localhost'),
    // db.createPostGress('Developer', 'bitssu', '8175Pass', tabelAutonumber, tabelUser, 'Secret-Key-is=8175Pass', 'serambits.selfip.net'),
    // db.createFirebird('E:/Kerja/BITS/Programing/DesktopBase/Suhandry (keramik Veteran)/Database/thedb.gdb', 'SYSDBA', 'masterkey'),
  ],
  // CLISTDB : [
  //   db.createPostGress('Developer',
  //     'bitssu', 
  //     '8175Pass', 
  //     tabelAutonumber, 
  //     tabelUser, 
